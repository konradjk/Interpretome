...
$WikiTitle = 'Interpretome wiki';
$PageLogoUrl = "http://esquilax.stanford.edu/media/graphics/interpretome.png";
...
$DefaultPasswords['admin'] = crypt('GWAS4life');
$DefaultPasswords['edit'] = crypt('23andyou');
